...
The application was designed for directories containing up to 10k images, short (<5 minutes) videos and audio files. File names are assumed to be non-descriptive. Examples of such directories are:
